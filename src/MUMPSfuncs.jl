function solveMUMPS(A::SparseMatrixCSC, rhs::Array, x::Array=[], sym=0,ooc=0,tr=0)
...
function factorMUMPS(A::SparseMatrixCSC{Complex128,Int},sym=0,ooc=0)
	...
	n  = size(A,1);
 	mumpsstat = [0];
	tic()
    p  = ccall( (:factor_mumps_cmplx_, "/Users/lruthot/.julia/v0.4/MUMPS/lib/MUMPS"),
...
function factorMUMPS(A::SparseMatrixCSC{Float64,Int},sym=0,ooc=0)
	...
	n  = size(A,1);
 	mumpsstat = [0];
	tic()
	p  = ccall( (:factor_mumps_, "/Users/lruthot/.julia/v0.4/MUMPS/lib/MUMPS"),
...
function applyMUMPS(factor::MUMPSfactorization,rhs::Array,x::Array=[],tr=0)
	...
	ptr = factor.ptr
	if factor.real
		ccall( (:solve_mumps_, "/Users/lruthot/.julia/v0.4/MUMPS/lib/MUMPS"),
				Int64, (Ptr{Int64}, Ptr{Int64}, Ptr{Float64}, Ptr{Float64}, Ptr{Int64} ),
							&ptr,      &nrhs, 	 	rhs, x, &tr)
	else
		ccall( (:solve_mumps_cmplx_, "/Users/lruthot/.julia/v0.4/MUMPS/lib/MUMPS"),
...
function destroyMUMPS(factor::MUMPSfactorization)
	...
	if factor.real
		ccall( (:destroy_mumps_, "/Users/lruthot/.julia/v0.4/MUMPS/lib/MUMPS"),
				Int64, (Ptr{Int64}, ), &factor.ptr )
	else
	 	ccall( (:destroy_mumps_cmplx_, "/Users/lruthot/.julia/v0.4/MUMPS/lib/MUMPS"),
	 			Int64, (Ptr{Int64}, ), &factor.ptr )
	end
	factor.ptr = -1
	factor.n    = -1
